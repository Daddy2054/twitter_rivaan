...
class UserProfileController extends StateNotifier<bool> {
  ...
  UserProfileController({
    ...
    required UserAPI userAPI, required NotificationController notificationController,
  })  : _tweetAPI = tweetAPI,
  ...
  void followUser({
    ...
    res.fold((l) => showSnackBar(context, l.message), (r) async {
      ...
      res2.fold((l) => showSnackBar(context, l.message), (r) {  _notificationController.createNotification(
